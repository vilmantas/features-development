...
namespace Features.Buffs
{
    public class BuffContainer
    {
        ...
        public BuffContainer RegisterCallbacks(
            Action<ActiveBuff> onBuffRemoved, Action<ActiveBuff> onBuffAdded,
            Action<ActiveBuff> onBuffStackRemoved, Action<ActiveBuff> onBuffStackAdded)
        {
        ...
        public void Receive(BuffBase buff, object source, int stacks = 1)
        {
            ...
            if (existingBuff == null)
            {
                ...
                existingBuff.RegisterCallbacks(m_OnBuffStackRemoved, m_OnBuffStackAdded);
