...
namespace Features.Equipment
{
    public class Container
    {
        ...
        private EquipResult EquipByItem(EquipRequest request)
        {
            ...
            var result = Manager.EquipOrReplace(slot, request.Item, out var prevItem, out var combined);
        ...
        {
            var item = Manager.EquipOrReplace(request.Slot, request.Item, out var prevItem, out var combined);
        ...
        {
            var item = Manager.EquipOrReplace(request.SlotId, request.Item, out var prevItem, out var combined);
